...
var ServerCookies = _interopDefault(require('cookies'));
var ClientCookies = _interopDefault(require('cookies-js'));
var withRedux = _interopDefault(require('next-redux-wrapper'));
var React = require('react');
var redux = require('redux');
var reduxPersist = require('redux-persist');
var reduxPersistCookieStorage = require('redux-persist-cookie-storage');
...
const withReduxCookiePersist = (makeStore, config) => {
    ...
    const extractStateFromCookies = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const cookies = new reduxPersistCookieStorage.NodeCookiesWrapper(new ServerCookies(req, res));
        const persistConfig = Object.assign(Object.assign({}, sharedPersistConfig), { storage: new reduxPersistCookieStorage.CookieStorage(cookies) });
        let state;
        try {
            state = yield reduxPersist.getStoredState(persistConfig);
        }
        catch (error) {
            /* istanbul ignore if */
            if (debug) {
    ...
    function flushReduxStateToCookies() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const reducer = reduxPersist.persistReducer(persistConfig, (state, action) => state);
            const store = redux.createStore(reducer, this.store.getState());
    ...
    const wrappedMakeStore = (initialState, options) => {
        ...
        if (!options.isServer) {
            ...
            const persistConfig = Object.assign(Object.assign({}, sharedPersistConfig), { storage: new reduxPersistCookieStorage.CookieStorage(ClientCookies) });
            ...
            const persistoid = reduxPersist.createPersistoid(persistConfig);
    ...
    return (App) => {
        ...
        return _a = class CookiePersistedWrappedApp extends React.Component {
                render() {
                    return React.createElement(WrappedApp, Object.assign({}, this.props));
                }
            },
...
exports.withReduxCookiePersist = withReduxCookiePersist;
